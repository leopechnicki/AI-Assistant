...
import { type HexConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: HexConfig): string[] {
...
export function listAgentsForGateway(cfg: HexConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: HexConfig): string {
...
function resolveSessionStoreAgentId(cfg: HexConfig, canonicalKey: string): string {
...
export function resolveGatewaySessionStoreTarget(params: { cfg: HexConfig; key: string }): {
  agentId: string;
  storePath: string;
  canonicalKey: string;
  storeKeys: string[];
...
export function loadCombinedSessionStoreForGateway(cfg: HexConfig): {
  storePath: string;
...
export function getSessionDefaults(cfg: HexConfig): GatewaySessionsDefaults {
