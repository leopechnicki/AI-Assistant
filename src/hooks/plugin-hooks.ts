...
import type { HexPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: HexPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: HexPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
