...
export function listSignalAccountIds(cfg: HexConfig): string[] {
...
export function resolveDefaultSignalAccountId(cfg: HexConfig): string {
...
function mergeSignalAccountConfig(cfg: HexConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: HexConfig): ResolvedSignalAccount[] {
