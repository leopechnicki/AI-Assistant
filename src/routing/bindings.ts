...
export function listBindings(cfg: HexConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: HexConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: HexConfig) {
