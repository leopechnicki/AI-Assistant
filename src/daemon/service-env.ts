...
export function buildServiceEnvironment(params: {
  ...
  const stateDir = env.HEX_STATE_DIR;
  const configPath = env.HEX_CONFIG_PATH;
  return {
    HOME: env.HOME,
    PATH: buildMinimalServicePath({ env }),
    HEX_PROFILE: profile,
    HEX_STATE_DIR: stateDir,
    HEX_CONFIG_PATH: configPath,
    HEX_GATEWAY_PORT: String(port),
    HEX_GATEWAY_TOKEN: token,
    HEX_LAUNCHD_LABEL: resolvedLaunchdLabel,
    HEX_SYSTEMD_UNIT: systemdUnit,
    HEX_SERVICE_MARKER: GATEWAY_SERVICE_MARKER,
    HEX_SERVICE_KIND: GATEWAY_SERVICE_KIND,
...
export function buildNodeServiceEnvironment(params: {
  ...
  return {
    ...
    HEX_STATE_DIR: stateDir,
    HEX_CONFIG_PATH: configPath,
    HEX_LAUNCHD_LABEL: resolveNodeLaunchAgentLabel(),
    HEX_SYSTEMD_UNIT: resolveNodeSystemdServiceName(),
    HEX_WINDOWS_TASK_NAME: resolveNodeWindowsTaskName(),
    HEX_TASK_SCRIPT_NAME: NODE_WINDOWS_TASK_SCRIPT_NAME,
    HEX_LOG_PREFIX: "node",
    HEX_SERVICE_MARKER: NODE_SERVICE_MARKER,
    HEX_SERVICE_KIND: NODE_SERVICE_KIND,
    HEX_SERVICE_VERSION: VERSION,
  };
}
