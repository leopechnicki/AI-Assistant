...
function listConfiguredAccountIds(cfg: HexConfig): string[] {
...
export function listWhatsAppAuthDirs(cfg: HexConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: HexConfig): boolean {
  return listWhatsAppAuthDirs(cfg).some((authDir) => hasWebCredsSync(authDir));
}

export function listWhatsAppAccountIds(cfg: HexConfig): string[] {
...
export function resolveDefaultWhatsAppAccountId(cfg: HexConfig): string {
...
export function resolveWhatsAppAuthDir(params: { cfg: HexConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: HexConfig): ResolvedWhatsAppAccount[] {
