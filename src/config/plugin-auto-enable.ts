...
function isTelegramConfigured(cfg: HexConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: HexConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: HexConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: HexConfig): boolean {
...
function isIMessageConfigured(cfg: HexConfig): boolean {
...
function isWhatsAppConfigured(cfg: HexConfig): boolean {
...
function isGenericChannelConfigured(cfg: HexConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: HexConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: HexConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: HexConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: HexConfig, pluginId: string): boolean {
...
function ensureAllowlisted(cfg: HexConfig, pluginId: string): HexConfig {
...
function enablePluginEntry(cfg: HexConfig, pluginId: string): HexConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {
