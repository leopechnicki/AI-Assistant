...
function resolveAnthropicDefaultAuthMode(cfg: HexConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: HexConfig): HexConfig {
...
export function applyTalkApiKey(config: HexConfig): HexConfig {
...
export function applyModelDefaults(cfg: HexConfig): HexConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: HexConfig): HexConfig {
...
export function applyLoggingDefaults(cfg: HexConfig): HexConfig {
...
export function applyContextPruningDefaults(cfg: HexConfig): HexConfig {
...
export function applyCompactionDefaults(cfg: HexConfig): HexConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
