...
const _ensureModels = (cfg: HexConfig, agentDir: string) =>
  ensureHexModelsJson(cfg, agentDir) as unknown;
...
describe("buildEmbeddedSandboxInfo", () => {
  ...
  it("maps sandbox context into prompt info", () => {
    const sandbox = {
      ...
      workspaceDir: "/tmp/hex-sandbox",
      agentWorkspaceDir: "/tmp/hex-workspace",
      ...
      browser: {
        ...
        containerName: "hex-sbx-browser-test",
      },
