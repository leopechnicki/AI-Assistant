...
function resolveAvatarSource(cfg: HexConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: HexConfig, agentId: string): AgentAvatarResolution {
