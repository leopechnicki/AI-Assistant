...
export class DirectoryCache<T> {
  ...
  private lastConfigRef: HexConfig | null = null;

  constructor(private readonly ttlMs: number) {}

  get(key: string, cfg: HexConfig): T | undefined {
  ...
  set(key: string, value: T, cfg: HexConfig): void {
    this.resetIfConfigChanged(cfg);
  ...
  private resetIfConfigChanged(cfg: HexConfig): void {
