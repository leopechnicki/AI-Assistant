...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.HEX_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: HexConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: HexConfig): string {
...
function mergeTelegramAccountConfig(cfg: HexConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: HexConfig): ResolvedTelegramAccount[] {
