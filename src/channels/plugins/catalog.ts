...
import type { HexPackageManifest } from "../../plugins/manifest.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { ChannelMeta } from "./types.js";
import { MANIFEST_KEY } from "../../compat/legacy-names.js";
import { discoverHexPlugins } from "../../plugins/discovery.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, HexPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["HEX_PLUGIN_CATALOG_PATHS", "HEX_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<HexPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: HexPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverHexPlugins({ workspaceDir: options.workspaceDir });
