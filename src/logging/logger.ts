...
export const DEFAULT_LOG_DIR = "/tmp/hex";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "hex.log"); // legacy single-file path

const LOG_PREFIX = "hex";
...
function resolveSettings(): ResolvedSettings {
  let cfg: HexConfig["logging"] | undefined =
    (loggingState.overrideSettings as LoggerSettings | null) ?? readLoggingConfig();
  if (!cfg) {
    try {
      const loaded = requireConfig("../config/config.js") as {
        loadConfig?: () => HexConfig;
      };
