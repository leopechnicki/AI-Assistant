...
function resolveDefaultAccountId(cfg: HexConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: HexConfig): boolean {
...
export function summarizeBindings(cfg: HexConfig, bindings: AgentBinding[]): string[] {
