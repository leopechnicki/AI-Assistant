...
export function applyZaiConfig(cfg: HexConfig): HexConfig {
...
export function applyOpenrouterProviderConfig(cfg: HexConfig): HexConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayProviderConfig(cfg: HexConfig): HexConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyVercelAiGatewayConfig(cfg: HexConfig): HexConfig {
...
export function applyOpenrouterConfig(cfg: HexConfig): HexConfig {
...
export function applyMoonshotProviderConfig(cfg: HexConfig): HexConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: HexConfig): HexConfig {
...
export function applyMoonshotConfig(cfg: HexConfig): HexConfig {
...
export function applyMoonshotConfigCn(cfg: HexConfig): HexConfig {
...
export function applyKimiCodeProviderConfig(cfg: HexConfig): HexConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: HexConfig): HexConfig {
...
export function applySyntheticProviderConfig(cfg: HexConfig): HexConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: HexConfig): HexConfig {
...
export function applyXiaomiProviderConfig(cfg: HexConfig): HexConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: HexConfig): HexConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: HexConfig): HexConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: HexConfig): HexConfig {
...
export function applyXaiProviderConfig(cfg: HexConfig): HexConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: HexConfig): HexConfig {
