...
function resolveConfiguredModelRaw(cfg: HexConfig): string {
...
function resolveConfiguredModelKeys(cfg: HexConfig): string[] {
...
export function applyPrimaryModel(cfg: HexConfig, model: string): HexConfig {
...
export function applyModelAllowlist(cfg: HexConfig, models: string[]): HexConfig {
  const defaults = cfg.agents?.defaults;
