...
export async function statusCommand(
  ...
  runtime.log(theme.heading("Hex status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("hex security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("hex security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.hex.ai/faq");
  runtime.log("Troubleshooting: https://docs.hex.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("hex status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("hex logs --follow")}`);
  if (gatewayReachable) {
