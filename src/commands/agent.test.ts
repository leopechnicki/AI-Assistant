...
async function withTempHome<T>(fn: (home: string) => Promise<T>): Promise<T> {
  return withTempHomeBase(fn, { prefix: "hex-agent-" });
}

function mockConfig(
  home: string,
  storePath: string,
  agentOverrides?: Partial<NonNullable<NonNullable<HexConfig["agents"]>["defaults"]>>,
  telegramOverrides?: Partial<NonNullable<HexConfig["telegram"]>>,
