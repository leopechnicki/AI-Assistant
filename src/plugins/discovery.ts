...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @hex/voice-call -> voice-call).
...
export function discoverHexPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".hex", "extensions")];
