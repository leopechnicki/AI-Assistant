...
function mergeFeishuAccountConfig(cfg: HexConfig, accountId: string): FeishuAccountConfig {
...
export function listFeishuAccountIds(cfg: HexConfig): string[] {
...
export function resolveDefaultFeishuAccountId(cfg: HexConfig): string {
