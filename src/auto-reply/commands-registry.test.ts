...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@hex", { botUsername: "hex" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@hex args", {
        botUsername: "hex",
      }),
    ).toBe("/help args");
    expect(
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "hex" })).toBe(
      "/help@otherbot",
    );
  });
