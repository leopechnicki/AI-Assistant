...
export const A2UI_PATH = "/__hex__/a2ui";

export const CANVAS_HOST_PATH = "/__hex__/canvas";

export const CANVAS_WS_PATH = "/__hex__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.hexCanvasA2UIAction.postMessage(...)
  // - Android: window.hexCanvasA2UIAction.postMessage(...)
  const handlerNames = ["hexCanvasA2UIAction"];
  ...
  globalThis.Hex = globalThis.Hex ?? {};
  globalThis.Hex.postMessage = postToNode;
  globalThis.Hex.sendUserAction = sendUserAction;
  globalThis.hexPostMessage = postToNode;
  globalThis.hexSendUserAction = sendUserAction;
