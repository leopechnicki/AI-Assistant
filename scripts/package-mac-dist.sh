...
# Output:
# - dist/Hex.app
# - dist/Hex-<version>.zip
# - dist/Hex-<version>.dmg
...
ZIP="$ROOT_DIR/dist/Hex-$VERSION.zip"
DMG="$ROOT_DIR/dist/Hex-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/Hex-$VERSION.notary.zip"
DSYM_ZIP="$ROOT_DIR/dist/Hex-$VERSION.dSYM.zip"
