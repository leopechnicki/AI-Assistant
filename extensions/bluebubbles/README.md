...
This directory contains the **BlueBubbles external channel plugin** for Hex.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `hex/plugin-sdk` helpers.
