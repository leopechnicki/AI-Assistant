...
export function listBlueBubblesAccountIds(cfg: HexConfig): string[] {
...
export function resolveDefaultBlueBubblesAccountId(cfg: HexConfig): string {
...
export function listEnabledBlueBubblesAccounts(cfg: HexConfig): ResolvedBlueBubblesAccount[] {
