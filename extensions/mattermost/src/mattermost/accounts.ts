...
export function listMattermostAccountIds(cfg: HexConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: HexConfig): string {
...
export function listEnabledMattermostAccounts(cfg: HexConfig): ResolvedMattermostAccount[] {
