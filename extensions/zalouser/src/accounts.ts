...
export function listZalouserAccountIds(cfg: HexConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: HexConfig): string {
...
function mergeZalouserAccountConfig(cfg: HexConfig, accountId: string): ZalouserAccountConfig {
