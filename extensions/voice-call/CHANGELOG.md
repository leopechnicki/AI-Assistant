...
- Version alignment with core Hex release numbers.
...
- First public release of the @hex/voice-call plugin.
...
- CLI: `hex voicecall` commands (call/start/continue/speak/end/status/tail/expose).
