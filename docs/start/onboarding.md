---
summary: "First-run onboarding flow for Hex (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give Hex">
...
<Step title="CLI">
  ...
  The app can install the global `hex` CLI via npm/pnpm so terminal
