...
- Install via CLI: `hex plugins install @hex/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `hex plugins install ./extensions/zalo`
   - From npm (if published): `hex plugins install @hex/zalo`
...
- Approve via:
  - `hex pairing list zalo`
  - `hex pairing approve zalo <CODE>`
...
- Example: `hex message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `hex channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `hex logs --follow`
