...
read_when:
  - You are building a Hex plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (hex.plugin.json)

Every plugin **must** ship a `hex.plugin.json` file in the **plugin root**.
Hex uses this manifest to validate configuration **without executing plugin
