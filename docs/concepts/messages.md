...
This page ties together how Hex handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. Hex keeps a
...
Hex separates the **prompt body** from the **command body**:
...
Hex can expose or hide model reasoning:
