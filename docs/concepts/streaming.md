...
Hex has two separate “streaming” layers:
...
When block streaming is enabled, Hex can **merge consecutive block chunks**
...
When draft streaming is active, Hex disables block streaming for that reply to avoid double-streaming.
