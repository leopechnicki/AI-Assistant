...
You can point Hex at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or Hex
...
- [Anthropic provider](/providers/anthropic) - Native Hex integration with Claude setup-token or API keys
