---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with Hex"
read_when:
  - You want Xiaomi MiMo models in Hex
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). Hex uses
