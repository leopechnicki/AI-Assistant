...
This guide summarizes a sane workflow for working on the pi integration in Hex.
...
- Trigger the agent directly:
  - `pnpm hex agent --message "Hello" --thinking low`
...
State lives under the Hex state directory. Default is `~/.hex`. If `HEX_STATE_DIR` is set, use that directory instead.
...
- https://docs.hex.ai/testing
- https://docs.hex.ai/start/getting-started
